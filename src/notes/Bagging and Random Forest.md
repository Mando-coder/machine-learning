...
Techniques like Bagging and Random Forest are examples of ensemble methods, which combine weak learners like decision trees to form a more complex model. The main disadvantage is that you trade in complexity for interprebility.
